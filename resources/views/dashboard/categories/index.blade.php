...
@section('container')
    <div class="bg-gray-800 pt-3">
        <div class="rounded-tl-3xl bg-gradient-to-r from-blue-900 to-gray-800 p-4 shadow text-2xl text-white">
            <h3 class="font-bold pl-2">Post Categories</h3>
        </div>
    </div>

    <body class="flex items-center justify-center">
        <div class="container mt-10 mb-2">
            <a href="/dashboard/categories/create" class="py-3 px-8 mx-8 bg-blue-700 text-white font-bold rounded-md"> New Category
            </a>
                ...
                <tbody class="flex-1 sm:flex-none">
                    ...
                    <tr class="bg-teal-400 flex flex-col flex-no wrap sm:table-row sm:rounded-none mb-2 sm:mb-0">
                        ...
                        <th class="p-3 text-left" width="110px">
                          {{-- view data baru --}}
                          <a href="/dashboard/categories/{{ $category->slug }}"><i class="fas fa-folder-open"></i></a>
                          {{-- edit data --}}
                          <a href="/dashboard/categories/{{ $category->slug }}/edit"><i class="far fa-edit"></i></a>
                          {{-- delete data --}}
